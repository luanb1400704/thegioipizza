...
@section('content')
    ...
    <section class="content">
        <form role="form" action="{{ route('kh.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="kh_ngaysinh">
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_ch">
                                    ...
                                    @foreach ($kh as $key => $val)
                                        <option value="{{ $val->id }}">{{ $val->phone }} - {{ $val->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Mật Khẩu</label>
                                <input type="password" class="form-control" name="kh_matkhau">
                            </div>
                        </div>
                    </div>
                </div>
